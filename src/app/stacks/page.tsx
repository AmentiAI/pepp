...
const stacks: Stack[] = [
  {
    ...
    compounds: [
      { name: 'GHK-Cu', role: 'Skin regeneration & collagen', dose: '1–2mg/day topical or subQ', href: '/products/ghk-cu-50mg' },
      { name: 'CJC-1295', role: 'GHRH analog — GH pulse', dose: '100mcg pre-sleep', href: '/products/ipamorelin-cjc-1295-blend-10mg' },
      { name: 'Ipamorelin', role: 'GHRP — GH release', dose: '200mcg pre-sleep', href: '/products/ipamorelin-cjc-1295-blend-10mg' },
    ],
    benefits: [
  ...
  },
  {
    ...
    compounds: [
      { name: 'Retatrutide', role: 'GLP-1/GIP/Glucagon tri-agonist', dose: '2–12mg/week escalating', href: '/products/retatrutide-10mg' },
      { name: 'CJC-1295', role: 'GH axis preservation', dose: '100mcg 2× daily', href: '/products/ipamorelin-cjc-1295-blend-10mg' },
      { name: 'Ipamorelin', role: 'Lean mass protection', dose: '200mcg 2× daily', href: '/products/ipamorelin-cjc-1295-blend-10mg' },
      { name: 'BPC-157', role: 'Gut health during deficit', dose: '250mcg 2× daily', href: '/products/bpc-157-10mg' },
    ],
    benefits: [
  ...
  },
  {
    ...
    compounds: [
      { name: 'IGF-1 LR3', role: 'Satellite cell activation / hyperplasia', dose: '50–100mcg post-training', href: '/products/igf-1-lr3-1mg' },
      { name: 'CJC-1295', role: 'Sustained GH elevation', dose: '100mcg 2× daily', href: '/products/ipamorelin-cjc-1295-blend-10mg' },
      { name: 'Ipamorelin', role: 'GH pulse amplification', dose: '200mcg 2× daily', href: '/products/ipamorelin-cjc-1295-blend-10mg' },
      { name: 'BPC-157', role: 'Recovery & joint protection', dose: '250–500mcg daily', href: '/products/bpc-157-10mg' },
    ],
    benefits: [
  ...
  },
  {
    ...
    compounds: [
      { name: 'BPC-157', role: 'Tendon, joint & gut healing', dose: '250–500mcg daily', href: '/products/bpc-157-10mg' },
      { name: 'TB-500', role: 'Systemic tissue repair', dose: '2–5mg 2× per week', href: '/products/tb-500-10mg' },
    ],
    benefits: [
  ...
  },
  {
    ...
    compounds: [
      { name: 'Epithalon', role: 'Telomerase activation / lifespan', dose: '5–10mg daily × 10 days', href: '/products/epitalon-50mg' },
      { name: 'GHK-Cu', role: 'Gene expression reset', dose: '1–2mg daily', href: '/products/ghk-cu-50mg' },
    ],
    benefits: [
  ...
  },
  {
    ...
    compounds: [
      { name: 'Retatrutide', role: 'Fat loss & metabolic optimization', dose: '4–8mg/week', href: '/products/retatrutide-10mg' },
      { name: 'IGF-1 LR3', role: 'Muscle hyperplasia', dose: '50–100mcg post-training', href: '/products/igf-1-lr3-1mg' },
      { name: 'GHK-Cu', role: 'Skin & gene expression', dose: '1–2mg daily', href: '/products/ghk-cu-50mg' },
      { name: 'BPC-157', role: 'Recovery & gut health', dose: '250–500mcg daily', href: '/products/bpc-157-10mg' },
      { name: 'Epithalon', role: 'Longevity & telomeres', dose: '5–10mg daily × 10 days', href: '/products/epitalon-50mg' },
    ],
    benefits: [
